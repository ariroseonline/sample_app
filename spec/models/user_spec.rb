...
describe User do
  ...
  it "should reject invalid email addresses" do
    addresses = %w[user@foo,com THE_USER@foo_bar.org first.last@foo.]
    addresses.each do |address|
  ...
  describe "password_validations" do
      it "should require a password" do
        User.new(@attr.merge(:password => "", :password_confirmation => "")).#goes thru validation stage here
        
        should_not be_valid
      end
      
      it "should require a matching password confirmation" do
        User.new(@attr.merge(:password_confirmation => "invalid")).#goes thru validation stage here
      ...
      it "should reject short passwords" do 
        ...
        User.new(hash).#goes thru validation stage here
        should_not be_valid
      end
